...
const nihssItemsDefinition = [
  {
    ...
    items: [
      {
        id: "1a",
        label: "1a. Úroveň vedomia",
        max: 3,
        options: [
          "0: V bdelom stave",
          "1: Reaguje na oslovenie",
          "2: Reaguje na bolesť",
          "3: Nereaguje",
        ],
        helpText:
          "Hodnotenie bdelosti. Ak treba, stimulujte oslovením, potom bolestivým podnetom.",
      },
      {
        id: "1b",
        label: "1b. Otázky (mesiac, vek)",
        max: 2,
        options: [
          "0: Správne odpovede",
          "1: 1 správna odpoveď",
          "2: Žiadna správna odpoveď",
        ],
        helpText:
          'Spýtajte sa: "Aký je mesiac?" a "Koľko máte rokov?". Netoleruje sa ani čiastočná odpoveď.',
      },
      {
        id: "1c",
        label: "1c. Príkazy (zavrieť/otvoriť oči, ruka)",
        max: 2,
        options: ["0: Vyhovie obom", "1: Vyhovie jednému", "2: Nevyhovie"],
        helpText:
          'Vyzvite: "Otvorte a zavrite oči." a "Zovrite a uvoľnite päsť (ne-paretickou rukou)".',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        options: [
          "0: Normálny",
          "1: Čiastočná deviácia",
          "2: Vynútená deviácia",
        ],
        helpText:
          "Sledujte spontánne pohyby očí. Potom vyzvite pacienta, aby sledoval váš prst.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "3",
        label: "3. Zorné pole (vyšetrenie konfrontáciou)",
        max: 3,
        options: [
          "0: Normálne",
          "1: Čiastočná hemianopsia",
          "2: Úplná hemianopsia",
          "3: Bilaterálna slepota",
        ],
        helpText:
          "Testujte 4 kvadranty vizuálnou konfrontáciou (pohybujúce sa prsty).",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "4",
        label: "4. Paréza tváre",
        max: 3,
        options: [
          "0: Normálna symetria",
          "1: Minimálna (kútik)",
          "2: Čiastočná (celá dolná tvár)",
          "3: Úplná (1/2 tváre)",
        ],
        helpText:
          "Vyzvite pacienta, aby ukázal zuby, zdvihol obočie a pevne zavrel oči.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "5a",
        label: "5a. Ľavá horná končatina",
        max: 4,
        options: [
          "0: Udrží 10s",
          "1: Klesá",
          "2: Klesá predčasne",
          "3: Pohyb proti gravitácii",
          "4: Žiaden pohyb",
          "9: Nehodnotiteľné (amputácia)",
        ],
        helpText: "Ruka v predpažení 10 sekúnd (dlaňou dolu). Hodnoťte pokles.",
      },
      {
        id: "5b",
        label: "5b. Pravá horná končatina",
        max: 4,
        options: [
          "0: Udrží 10s",
          "1: Klesá",
    ...
    items: [
      {
        ...
        helpText: "Noha zdvihnutá v 30° uhle na 5 sekúnd. Hodnoťte pokles.",
      },
      {
        id: "6b",
        label: "6b. Pravá dolná končatina",
        max: 4,
        options: [
          "0: Udrží 5s (30°)",
          "1: Klesá",
  ...
  },
  {
    ...
    items: [
      {
        id: "7",
        label: "7. Ataxia končatín (prst-nos, päta-koleno)",
        max: 2,
        options: [
          "0: Bez ataxie",
          "1: Prítomná v 1 končatine",
          "2: Prítomná v 2+ končatinách",
          "9: Nehodnotiteľné",
        ],
        helpText:
          'Test "prst-nos" a "päta-koleno". Hodnoťte len ataxiu, ktorá nie je spôsobená slabosťou.',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "8",
        label: "8. Senzitíva (citlivosť na pichnutie)",
        max: 2,
        options: [
          "0: Normálna",
          "1: Mierna porucha",
          "2: Vážna porucha / kóma",
        ],
        helpText:
          "Testujte citlivosť na pichnutie (napr. špendlíkom) na tvári, rukách a nohách. Porovnajte strany.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "9",
        label: "9. Jazyk / Afázia (popis obrázku, pomenovanie)",
        max: 3,
        options: [
          "0: Bez afázie",
          "1: Mierna afázia",
          "2: Vážna afázia",
          "3: Globálna afázia / mutizmus",
        ],
        helpText:
          "Ukážte predmety (kľúč, pero), požiadajte o pomenovanie. Požiadajte o popis situácie.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "10",
        label: "10. Dyzartria (artikulácia)",
        max: 2,
        options: [
          "0: Normálna artikulácia",
          "1: Mierna dyzartria",
          "2: Vážna / nezrozumiteľná reč",
          "9: Nehodnotiteľné (intubácia)",
        ],
        helpText:
          "Požiadajte pacienta, aby prečítal zoznam slov (napr. MAMA, TATA, ARTILÉRIA).",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        helpText:
          "Testujte simultánny dotyk na oboch stranách tváre/rúk. Spýtajte sa, či cíti obe.",
      },
    ],
  },
];
...
function getRecommendation(patientData) {
  const { ctResult, timeWindow, ctagResult, perfusionResult, befastTime } =
    patientData;
  ...
  if (ctResult === "ich") {
    return {
      ...
      description:
        "Liečba IVT a MTE je kontraindikovaná. Okamžite konzultovať neurochirurga.",
  ...
  if (ctResult === "other") {
    return {
      ...
      description:
        "Nález na CT nezodpovedá iCMP (napr. tumor). Zvážiť inú diagnózu a manažment.",
  ...
  if (ctResult === "ischemia") {
    ...
    if (timeWindow === "<4.5h") {
      if (ctagResult === "lvo") {
        return {
          ...
          description:
            "Pacient je v okne < 4.5h s LVO. Odporúča sa IVT (preferenčne Tenektepláza 0.25mg/kg) a následne MTE.",
      ...
      if (ctagResult === "no_lvo") {
        return {
          title: "IVT (Altepláza)",
          description:
            "Pacient je v okne < 4.5h bez LVO. Odporúča sa IVT (Altepláza 0.9mg/kg).",
          colorClass: "border-green-500 bg-green-700",
          details: [
            ...baseDetails,
            "Nález NCCT: Ischémia",
    ...
    if (timeWindow === "4.5-9h") {
      if (perfusionResult === "mismatch") {
        if (ctagResult === "lvo") {
          return {
            title: "IVT (Tenektepláza) + MTE",
            description:
              "Pacient je v okne 4.5-9h s LVO a dôkazom penumbry (mismatch). Odporúča sa IVT (preferenčne Tenektepláza) a MTE.",
            colorClass: "border-green-500 bg-green-700",
            details: [
              ...baseDetails,
              "Nález NCCT: Ischémia",
        ...
        if (ctagResult === "no_lvo") {
          return {
            title: "IVT (Altepláza)",
            description:
              "Pacient je v okne 4.5-9h bez LVO, ale s dôkazom penumbry (mismatch). Odporúča sa IVT (Altepláza).",
            colorClass: "border-green-500 bg-green-700",
            details: [
              ...baseDetails,
              "Nález NCCT: Ischémia",
      ...
      if (perfusionResult === "no_mismatch") {
        return {
          ...
          description:
            "Pacient je v okne 4.5-9h bez dôkazu penumbry (mismatch). Reperfúzna liečba sa neodporúča.",
          colorClass: "border-yellow-500 bg-yellow-700",
          details: [
            ...baseDetails,
            "Nález NCCT: Ischémia",
            "Okno: 4.5-9h",
            "Perfúzia: Mismatch NEPRÍTOMNÝ",
          ],
        };
      }
    }
    ...
    if (timeWindow === "basilaris>4.5h") {
      return {
        ...
        description:
          "Symptomatická oklúzia A. Basilaris > 4.5h bez rozsiahlej ischémie kmeňa. Odporúča sa IVT + MTE ako život zachraňujúci výkon.",
        colorClass: "border-orange-500 bg-orange-700",
        details: [
          ...baseDetails,
          "Nález NCCT: Ischémia",
          "Okno: Špeciálny prípad A. Basilaris > 4.5h",
        ],
      };
    }
  }
  ...
  return {
    ...
    description:
      "Nebolo možné určiť odporúčanie. Skontrolujte zadané parametre.",
...
const StartScreen = ({ onStart }) => (
  <div className="text-center">
    ...
    <p className="text-xl text-slate-300 mb-8">
      Sprievodca pre akútny príjem pacienta so suspektnou cievnou mozgovou
      príhodou.
    </p>
    <button
      onClick={onStart}
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-center text-blue-300 mb-6">
        Krok 1: BEFAST Skríning
      </h2>
      <form onSubmit={handleBefastSubmit} className="space-y-6">
        <div className="bg-slate-700 p-4 rounded-lg shadow-inner">
          <label
            htmlFor="time"
            className="block text-xl font-semibold text-yellow-300 mb-2"
          >
            T - Time (Čas)
          </label>
          <p className="text-sm text-slate-300 mb-3">
            Zadajte čas vzniku príznakov (alebo kedy bol pacient naposledy v
            poriadku).
          </p>
          <input
            type="time"
        ...
        {[
          {
            key: "B",
            label: "Balance (Rovnováha)",
            text: "Náhla strata rovnováhy alebo koordinácie?",
          },
          {
            key: "E",
            label: "Eyes (Oči)",
            text: "Náhla strata videnia alebo dvojité videnie?",
          },
          {
            key: "F",
            label: "Face (Tvár)",
            text: "Pokles ústneho kútika alebo viečka?",
          },
          {
            key: "A",
            label: "Arms (Ruky)",
            text: "Slabosť alebo necitlivosť ruky/nohy?",
          },
          {
            key: "S",
            label: "Speech (Reč)",
            text: "Nerozrozumiteľná reč alebo problém rozumieť?",
          },
        ].map((item) => (
          <div
            key={item.key}
            className="bg-slate-700 p-4 rounded-lg shadow-inner"
          >
            <label className="block text-xl font-semibold text-slate-100">
              {item.key} - {item.label}
            </label>
      ...
      {!ctActivated ? (
          ...
          <div className="bg-slate-700 p-6 rounded-lg shadow-inner space-y-4 mb-8">
            ...
            <div>
              ...
              <p
                className={`text-2xl font-bold ${
                  befastResult ? "text-red-400" : "text-green-400"
                }`}
              >
            ...
            {!befastResult && (
              <p className="text-yellow-400 text-lg p-4 bg-yellow-900/50 rounded-lg">
                BEFAST je negatívny. Zvážte iné diagnózy. Aktivácia CT nemusí
                byť nutná.
              </p>
            )}
          </div>
        ...
        <div className="bg-green-700 text-white p-8 rounded-lg shadow-xl text-center">
          ...
          <p className="text-lg mb-6">
            Teraz vykonajte NIHSS hodnotenie. Pacient je pripravený na
            transport.
          </p>
          <button
            onClick={onNext}
    ...
    <div>
      ...
      <form className="space-y-4">
        {nihssItemsDefinition.map((group) => (
          <fieldset
            key={group.group}
            className="bg-slate-700 p-4 rounded-lg shadow-inner border-t-4 border-blue-500"
          >
            <legend className="text-xl font-semibold text-slate-100 mb-4 px-2">
              {group.group}
            </legend>
            <div className="space-y-5">
              {group.items.map((item) => (
                <div key={item.id}>
                  <label
                    htmlFor={item.id}
                    className="block text-md font-medium text-slate-200 mb-1"
                  >
                    {item.label}
                  </label>
    ...
    <div className="bg-slate-700 p-6 rounded-lg shadow-inner space-y-4 mb-8 text-left">
      <div>
        ...
        <p className="text-2xl font-bold text-yellow-300">
          {patientData.befastTime || "Nezadaný"}
        </p>
      </div>
      ...
      <div>
        ...
        <p
          className={`text-2xl font-bold ${
            patientData.befastResult ? "text-red-400" : "text-green-400"
          }`}
        >
      ...
      <div>
        ...
        <p
          className={`text-2xl font-bold ${
            patientData.ctActivated ? "text-green-400" : "text-red-400"
          }`}
        >
      ...
      <div>
        ...
        <p className="text-5xl font-bold text-yellow-300 text-center py-4">
          {totalNihss}
        </p>
      </div>
    </div>
...
const CtResultsScreen = ({ patientData, dispatch, onNext, onBack }) => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-center text-blue-300 mb-6">
        Krok 5: Výsledky CT & CTAG
      </h2>
      <div className="space-y-6">
        {/* Q1: Nález Natívneho CT */}
        <div className="bg-slate-700 p-4 rounded-lg shadow-inner">
          <label className="block text-xl font-semibold text-slate-100 mb-3">
            Nález Natívneho CT (NCCT)
          </label>
          <div className="flex flex-col gap-2">
            <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-blue-600 has-[:checked]:font-bold">
              <input
                ...
                name="ctResult"
                value="ischemia"
                checked={ctResult === "ischemia"}
                onChange={(e) =>
                  handleCtFieldChange("ctResult", e.target.value)
                }
                className="mr-2"
              />{" "}
              Ischemická CMP (bez krvácania)
            </label>
        ...
        {ctResult === "ischemia" && (
          <>
              ...
              <div className="flex flex-col gap-2">
                <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-blue-600 has-[:checked]:font-bold">
                  <input
                    ...
                    name="timeWindow"
                    value="<4.5h"
                    checked={timeWindow === "<4.5h"}
                    onChange={(e) =>
                      handleCtFieldChange("timeWindow", e.target.value)
                    }
                    className="mr-2"
                  />{" "}
                  &lt; 4.5 hodiny (vrátane WUS &lt; 4.5h)
                </label>
                <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-blue-600 has-[:checked]:font-bold">
                  <input
                    type="radio"
                    name="timeWindow"
                    value="4.5-9h"
                    checked={timeWindow === "4.5-9h"}
                    onChange={(e) =>
                      handleCtFieldChange("timeWindow", e.target.value)
                    }
                    className="mr-2"
                  />{" "}
                  4.5 - 9 hodín (alebo WUS / Neznámy čas)
                </label>
                <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-orange-600 has-[:checked]:font-bold">
                  <input
                    type="radio"
                    name="timeWindow"
                    value="basilaris>4.5h"
                    checked={timeWindow === "basilaris>4.5h"}
                    onChange={(e) =>
                      handleCtFieldChange("timeWindow", e.target.value)
                    }
                    className="mr-2"
                  />{" "}
                  Špeciálny prípad: Oklúzia A. Basilaris &gt; 4.5h
                </label>
              </div>
            </div>
                ...
                <div className="flex flex-col gap-2">
                  <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-blue-600 has-[:checked]:font-bold">
                    <input
                      ...
                      name="ctagResult"
                      value="no_lvo"
                      checked={ctagResult === "no_lvo"}
                      onChange={(e) =>
                        handleCtFieldChange("ctagResult", e.target.value)
                      }
                      className="mr-2"
                    />{" "}
                    Bez oklúzie veľkej cievy (non-LVO)
                  </label>
                  <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-red-600 has-[:checked]:font-bold">
                    <input
                      type="radio"
                      name="ctagResult"
                      value="lvo"
                      checked={ctagResult === "lvo"}
                      onChange={(e) =>
                        handleCtFieldChange("ctagResult", e.target.value)
                      }
                      className="mr-2"
                    />{" "}
                    LVO - Oklúzia veľkej cievy (ACI/ACM/AB)
                  </label>
                </div>
              </div>
            )}
            ...
            {timeWindow === "4.5-9h" && (
              <div className="bg-slate-700 p-4 rounded-lg shadow-inner">
                <label className="block text-xl font-semibold text-slate-100 mb-3">
                  Nález Perfúzie (CTP) / Mismatch (MR)
                </label>
                <p className="text-sm text-slate-300 mb-3">
                  Vyžaduje sa pre okno 4.5-9h alebo neznámy čas vzniku.
                </p>
                <div className="flex flex-col gap-2">
                  <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-green-600 has-[:checked]:font-bold">
                    <input
                      type="radio"
                      name="perfusionResult"
                      value="mismatch"
                      checked={perfusionResult === "mismatch"}
                      onChange={(e) =>
                        handleCtFieldChange("perfusionResult", e.target.value)
                      }
                      className="mr-2"
                    />{" "}
                    Prítomný Mismatch / Penumbra (Core &lt; 70ml, Mismatch &gt;
                    1.2)
                  </label>
                  <label className="bg-slate-600 w-full text-left rounded-lg p-3 cursor-pointer has-[:checked]:bg-yellow-600 has-[:checked]:font-bold">
                    <input
                      ...
                      name="perfusionResult"
                      value="no_mismatch"
                      checked={perfusionResult === "no_mismatch"}
                      onChange={(e) =>
                        handleCtFieldChange("perfusionResult", e.target.value)
                      }
                      className="mr-2"
                    />{" "}
                    Neprítomný Mismatch / Penumbra
                  </label>
                </div>
              </div>
            )}
...
const RecommendationDisplay = ({ title, description, colorClass, details }) => (
  <div
    className={`text-white p-8 rounded-lg shadow-xl text-center border-t-8 ${colorClass}`}
  >
    <h3 className="text-3xl font-bold mb-3">{title}</h3>
    <p className="text-lg mb-6">{description}</p>
    <div className="bg-slate-800/50 p-4 rounded-lg text-left text-sm space-y-2">
      <p>
        <strong>Zhrnutie Dát:</strong>
      </p>
